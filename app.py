...
send_telegram_message(current_time_str, "<li><b>System Status:</b> Telegram automated integration is active and verified! Feed will broadcast every 15 minutes when new news breaks.</li>")